...
layout = html.Div(children=[
  ...
  #   # body block ends
    ...
    html.Div([
      ...
      html.Div([
        ...
        dcc.Upload(
        id='upload-data-plasmid-backbone-plasmid_map',
  ...
  html.Div([
      # the submit button 
      html.Button([dcc.Download(id="download-component-plasmid_map"), "Download Maps"], id = "download-button-plasmid_map", className = "download-button", n_clicks = 0, disabled = 'disabled'),
...
@app.callback(
    ...
    Output("download-button-plasmid_map", "disabled"),
    Output('upload-data-HAs-plasmid_map', 'style'),
    Output('upload-data-insert-plasmid_map', 'style'),
    Output('upload-data-plasmid-backbone-plasmid_map', 'style')],
    ...
    Input('upload-data-plasmid-backbone-plasmid_map', 'contents'),Input('upload-data-plasmid-backbone-plasmid_map', 'filename'),
    ])
def generate_maps(HA_content, HA_fname, INSERT_content, INSERT_fname, PB_content, PB_fname):
  input_ids = ['upload-data-HAs-plasmid_map', 'upload-data-insert-plasmid_map',  'upload-data-plasmid-backbone-plasmid_map']

  inputs= {'upload-data-HAs-plasmid_map': (HA_fname,HA_content), 'upload-data-insert-plasmid_map': (INSERT_fname,INSERT_content),'upload-data-plasmid-backbone-plasmid_map':(PB_fname,PB_content)}
  valid_inputs_dict = {}
  output_dict = {}
  ...
  if len(valid_inputs_dict) == len(input_ids):
    ...
    functions.create_plasmid_map(f'./{DATA_FOLDER_NAME}/upload-data-HAs-plasmid_map.gb', f'./{DATA_FOLDER_NAME}/upload-data-insert-plasmid_map.gb', f'./{DATA_FOLDER_NAME}/upload-data-plasmid-backbone-plasmid_map.gb', DATA_FOLDER_NAME)
  ...
  return updates_message, submit_state, output_dict['upload-data-HAs-plasmid_map'], output_dict['upload-data-insert-plasmid_map'], output_dict['upload-data-plasmid-backbone-plasmid_map']
...
def download_maps(n, DATA_FOLDER_NAME):
  ...
  if DATA_FOLDER_NAME == None:
    ...
    pathname = '/apps/plasmid_map' # redirecting to an unfilled both maps page to mimic reloading the page
